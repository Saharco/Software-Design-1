 ...
 */
abstract class SecureDocumentReference internal constructor(path: String, val storage: SecureStorage)
    : DocumentReference {
    protected val path: String = "$path/"
    private var data: HashMap<String, String> = HashMap()

    override fun set(field: Pair<String, String>): SecureDocumentReference {
        data[field.first] = field.second
        return this
    }

    override fun set(field: String, list: List<String>): SecureDocumentReference {
        val jsonString = Gson().toJson(list)
        data[field] = jsonString
        return this
    }

    override fun set(data: Map<String, String>): SecureDocumentReference {
